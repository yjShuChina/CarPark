        ...
        <form class="layui-form" onsubmit="return false;">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id ="role" name ="role" placeholder="请输入" autocomplete="off" class="layui-input">
                </div>
                <button class="layui-btn" lay-submit lay-filter="formDemo"><i class="layui-icon layui-icon-search"></i> 查询</button>
                <button title="新增角色" class="layui-btn-normal"  onclick="addParentMenu()"><i class="layui-icon layui-icon-add-circle"></i> 增加</button>
            </div>
        </form>
