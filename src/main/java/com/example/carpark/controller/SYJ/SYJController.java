package com.example.carpark.controller.SYJ;
...
//    }
    ...
    public void Login(String acc, HttpServletRequest request, HttpServletResponse response) {
        ...
        Gson g = new Gson();
        SYJTbadmin tbadmin = g.fromJson(acc, SYJTbadmin.class);
        if (captcha.equalsIgnoreCase(tbadmin.getCaptcha())) {

            SYJTbadmin admin1 = loginService.login(tbadmin.getAacc(), tbadmin.getApass());
