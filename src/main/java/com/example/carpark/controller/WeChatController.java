...
//		String endTime=null;
//		String count = String.valueOf(adminService.findCount(word,startTime,endTime));
...
//		}
		String allps= String.valueOf(carService.findParkSpacenum(word,""));//所有车位
		map.put("message", allps);
		return map;
	}
